...
class Sumo:
    ...
    def runangle(self, speed, rotation_angle):
        self.r_motor.run_angle(speed, rotation_angle, then=Stop.HOLD, wait=True)
        self.l_motor.run_angle(speed, rotation_angle, then=Stop.HOLD, wait=True)
        self.r1_motor.run_angle(-speed, rotation_angle, then=Stop.HOLD, wait=True)
        self.l1_motor.run_angle(-speed, rotation_angle, then=Stop.HOLD, wait=True)
